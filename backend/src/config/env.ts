...
import {schema, EnvSchema} from './env.schema';
...
function validateType(key: string, value: string, schema: EnvSchema[string]): string | null {
...
function displayValidationReport(errors: string[]): void {
    console.log('\n' + '='.repeat(60));
